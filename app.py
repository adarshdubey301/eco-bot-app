...
genai.configure(api_key=" myapi_f9ef7feb570c977a8e69a3cbf273a4bc0741c9fcb4024170df112170a0770032
")
...
if 'quiz_data' not in st.session_state:
    st.session_state['quiz_data'] = None  # Stores current AI generated question
...
def game_interface():
    ...
    with col1:
        ...
        if st.session_state['quiz_data']:
            ...
            # Map options to letters for checking
            opts = q['options']
            choice = st.radio("Select an answer:", opts, key="quiz_choice")
            
            # Find the letter of the selected choice (index 0=A, 1=B, etc)
            ...
            if st.button("Submit Answer"):
                if choice_letter == q['ans']:
                    ...
                    st.session_state['quiz_data'] = None # Reset for next question
                    time.sleep(2)
                    st.rerun()
                else:
...
def main():
    ...
    try:
        # A nice banner effect with the image
